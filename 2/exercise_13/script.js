...
function isBudgetEnough(data) {
    ...
    const shopsValue = shopsArea * data.height;
    const requiredMoney = shopsValue * data.moneyPer1m3;

    console.log(`Area ${shopsArea}`);
    console.log(`Value ${shopsValue}`);
    console.log(`Required ${requiredMoney}`);


    if (data.budget - requiredMoney >= 0) {
